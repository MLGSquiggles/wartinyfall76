...
namespace wartinyfall76.Tiles.Bendy
{
	public class InkMachineTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Ink Machine");
			AddMapEntry(new Color(221, 221, 188), name);
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Bendy.InkMachineItem>());
		}
	}
}