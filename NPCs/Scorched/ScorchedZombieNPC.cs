...
{
    //[AutoloadHead]
    public class ScorchedZombieNPC : ModNPC
    {
        //load texture for the npc
        public override string Texture
        {
            get { return "wartinyfall76/NPCs/Scorched/ScorchedZombieNPC"; }
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.SetDefault("Scorched Zombie");
