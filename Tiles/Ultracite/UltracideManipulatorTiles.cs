...
{
	public class UltracideManipulatorTiles : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Ultracide Manipulator");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			Item.NewItem(i * 16, j * 16, 48, 48, ModContent.ItemType<Items.Ultracite.UltracideManipulatorItem>());
		}
	}
}