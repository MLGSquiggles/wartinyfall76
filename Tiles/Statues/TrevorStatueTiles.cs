...
namespace wartinyfall76.Tiles.Statues
{
	public class TrevorStatueTiles : ModTile
	{
		public override void SetDefaults()
		{
			...
			AddMapEntry(new Color(54, 54, 54), name);
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			Item.NewItem(i * 16, j * 16, 48, 48, ModContent.ItemType<Items.Statues.TrevorStatue>());
		}
	}
}